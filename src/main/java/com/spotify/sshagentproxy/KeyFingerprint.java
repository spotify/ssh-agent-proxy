...
public class KeyFingerprint {
   ...
   */
  public KeyFingerprint(final RSAPublicKey publicKey) {
  ...
  private KeyFingerprint(final byte[] bytes) {
    this.bytes = Arrays.copyOf(bytes, bytes.length);
  }

  /**
   * This static constructor simply wraps the bytes in a new instance of this class.
   * @param bytes Bytes that represent an RSA public key's fingerprint.
   */
  public static KeyFingerprint of(final byte[] bytes) {
    return new KeyFingerprint(bytes);
  }
   ...
   */
  public boolean matches(final RSAPublicKey other) {
    return this.equals(new KeyFingerprint(other));
  }
  ...
  public boolean equals(Object o) {
    ...
    KeyFingerprint that = (KeyFingerprint) o;
